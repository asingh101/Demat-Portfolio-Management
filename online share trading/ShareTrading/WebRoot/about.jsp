    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
         ...
         <p><font size="4" color="black">Portfolio is a collection of asset i,e it means the total holding of securities belonging to any person.<br> </font><font size="4" color="black">Portfolio management is all about distributing money in one or more investments after analyzing their future returns.<br>
...
individuals and institutions, and balancing risk against performance.<br>There are at most three individuals involved &ndash; portfolio manager, broker and members of trade.<br></font><font size="4" color="black">Individuals register into trade and do his transactions. Broker creates
account for members, buy and sell trades on behalf of trade members.
While portfolio keep an eye on all these by regulating reports daily.<br>
Stock markets fluctuate widely, in marked contrast to the stability of
bank deposits or bonds. </font><font size="4" color="black"><br></font> 
          
          
          
         
   
          </p><p><font size="4" color="black">With a large amount of money to be made through
the stock market, the need for software to analyze the market and make
predictions about the direction in which the market is going is
increasing everyday.</font><font size="4" color="black"><br></font></p><p><br></p></div><div class="article"><br><p class="spec"><br></p>
          <div class="clr"></div>
        </div>
