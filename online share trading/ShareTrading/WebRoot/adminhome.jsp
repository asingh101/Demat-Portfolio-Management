      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="company.jsp"><font size="3" color="blue">Company 
           management</font></a></li>
            <li><a href="brokermgmnt.jsp"><font size="3" color="blue">Broker management</font></a></li>
            
            <li><a href="Adminuser.jsp"><font size="3" color="blue">Customer management</font></a></li>
            <li><a href="Admin_Feedback_Mgt.jsp"><font size="3" color="blue">Feedback</font></a></li>
            <li><a href="tips.jsp"><font size="3" color="blue">Tips of the day</font></a></li>
