...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar"><div class="article"><br><p class="spec"><br></p><br><div class="clr"></div>
        </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
           <li class="active">
            <a href="brokerhome.jsp"><font size="3">HOME</font></a></li>
            <li>
            <a href="brksale"><font size="3">SALE</font></a></li>
            <li><a href="brkpurchase"><font size="3">PURCHASE</font></a></li>
