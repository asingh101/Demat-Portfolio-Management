...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>EDIT COMPANY<br></span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; </p>
          <br>
          <s:form action="editcompany">
          <p><font size="3" color="black">Company Name &nbsp;&nbsp;</font><s:select label="compname" list="mapForSelect" name="comp_id"></s:select></p>
