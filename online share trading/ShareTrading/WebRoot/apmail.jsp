...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>E-mail <br></span></h2>
          <div class="clr"></div>&nbsp; <br>
           <p class="post-data"><a href="adminhome.jsp" class="com fr">Logout</a>
        <br><br>  
          <br><table>
          <s:form action="apmail"> 
           <tr><td><s:textfield name="name" label="Name" readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="e_mail" label="E-mail"readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="subject" label="Subject"readonly="true"></s:textfield></td></tr>
           <tr><td><s:textarea name="content" label="Content"readonly="true"></s:textarea></td></tr>
         <tr><td> <s:submit value="Send" align="center"></s:submit></td></tr>
          </s:form>
          </table>
        ...
        <div class="pagenavi"><span class="pages"></span><span class="current"></span><br></div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          <div class="search">
        ...
        <div class="gadget">
          ...
          <a href="Editbroker.jsp"><font size="3" color="black"></font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
