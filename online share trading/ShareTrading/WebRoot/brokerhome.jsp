...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Broker Home Page</span></h2>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="compsharedetail"><font size="3" color="blue">View Price</font></a></li>
            <li><a href="brokmr"><font size="3" color="blue">Profile</font></a></li>
            <li><a href="cust"><font size="3" color="blue">Customer Details</font></a></li>
            <li><a href="Transbrkr.jsp"><font size="3" color="blue">Transaction</font></a></li>
            <li><a href="Broker_Feedback_Mgt.jsp"><font size="3" color="blue">Message</font></a></li>
