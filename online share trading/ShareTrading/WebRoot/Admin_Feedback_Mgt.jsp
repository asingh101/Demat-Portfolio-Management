...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>ADMIN GIVE FEEDBACK</span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <br></p>
          <br>
           <br>
               
               <s:form action="seeFeed">
              <s:select name="select_level" label="Select level" list="{'user','broker','company'}" headerKey="-1" headerValue="------Please Select------" ></s:select>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <font size="3"></font><br></li>
                    <a href="adminhome.jsp"><font size="3" color="blue">Home</font></a>
