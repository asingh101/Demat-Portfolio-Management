...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>View History Details</span></h2>
          <div class="clr"></div>
          ...
          <br></div><div class="article"><br><p class="spec"><br></p>
          <div class="clr"></div>
        </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li class="active">
            <a href="#"><font size="3">Yesterday</font></a></li>
            <li><a href="#"><font size="3">Last 1 Week</font></a></li>
            <li><a href="#"><font size="3">Last 1 Month </font></a></li>
            </ul>
        </div>
        <div class="gadget">
          <h2><span></span></h2>
