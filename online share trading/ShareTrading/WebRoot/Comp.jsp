...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Company Home <br></span></h2>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="Editshare"><font size="3" color="blue">Edit Share<br></font></a></li>
            <li><a href="edcomp"><font size="3" color="blue">Edit Company<br></font></a>
            <li><a href="User_Feedback_Mgt.jsp"><font size="3" color="blue">Message</font></a></li>
