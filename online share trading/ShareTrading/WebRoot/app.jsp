...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>APPROVE/REJECT BROKER<br></span></h2>
          <div class="clr"></div>
          
          
                 <s:form action="app">
          <p><font size="3" color="black">Name Of Brokers&nbsp;&nbsp;</font><s:select label="SelectName" list="mapForSelect" name="broker_id"></s:select></p>
