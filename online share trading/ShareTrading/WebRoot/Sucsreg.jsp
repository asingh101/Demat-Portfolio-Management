    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <br>
          <p><font color="black" size="4">Your UserName Is:</font>&nbsp;&nbsp;<font color="red" size="5"><s:property value="username"/></font></p><br/>
          
          <p><font color="black" size="4">Your Password Is:</font>&nbsp;&nbsp;<font color="red" size="5"><s:property value="password"/></font></p><br/>
          
         <p><font color="blue" size="4">Successfully registered!!! Wait for approval..</font></p>
         
         <p align="center"><font size="5" color="green"><a href="user.jsp">Login Here</a></font></p>
