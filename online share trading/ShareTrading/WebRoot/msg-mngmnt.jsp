...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Message Management</span></h2>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <br><h2><span>&nbsp;<a href="#"><font size="4">Logout</font></a></span> </h2>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li class="active">
            <a href="#"><font size="3">Inbox</font></a>
           <a href="#"><font size="3">Compose</font></a>
           <a href="#"><font size="3">Sent Message</font></a>
