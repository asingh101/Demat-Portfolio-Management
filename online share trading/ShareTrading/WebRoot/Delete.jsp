      ...
      <div class="mainbar">
        <div class="article">
          ...
          <tr><td><s:textfield name="e_mail" label="Email" ></s:textfield></td></tr>
           <tr><td><font size="3" color="black"><s:textfield name="shareamt" label="Share Amount"></s:textfield></font></td></tr>
           <tr><td><font size="3" color="black"><s:textfield name="no_share" label="No of Share"></s:textfield></font></td></tr>
         <tr><td> <s:submit value="DELETE" align="center"></s:submit></td></tr>
  </s:form>
          </table>
