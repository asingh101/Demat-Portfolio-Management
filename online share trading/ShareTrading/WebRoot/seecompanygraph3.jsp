...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <br>
               ...
               System.out.println("Comp id is: "+cidd);
    ...
    String q5="SELECT to_char(DATEOFTRANS,'dd-mm-yyyy'),sum(no_share) from moreshare where comp_id=2519 and types='sold' group by(comp_id,DATEOFTRANS,types)";
    String q6="SELECT to_char(DATEOFTRANS,'dd-mm-yyyy'),sum(no_share) from moreshare where comp_id="+cidd+"  and dateoftrans between to_date('"+sdate+"','DD-MM-YY')-7 and '"+sdate+"' and types='bought' group by(comp_id,DATEOFTRANS,types) order by DATEOFTRANS";
    String query=q6;
    ...
    JFreeChart chart = ChartFactory .createBarChart3D("Complete Share-Purchase Graph",s,"No. of Shares",dataset,PlotOrientation.VERTICAL,true, true, false);
