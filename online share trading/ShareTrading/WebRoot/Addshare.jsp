...
<html>
  <head>
    ...
    <title>My JSP 'Add company.jsp' starting page</title>
...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>ADD SHARE</span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <br></p>
          <br>
          <table>
          <s:form action="addcomp">
          ...
          <tr><td><s:textfield name="shareamt" label="Share Amount"></s:textfield></td></tr>
          <tr><td><s:textfield name="no_share" label="No.of share"></s:textfield></td></tr>
          <tr><td><s:textfield name="stockIndex" label="Stock Index"></s:textfield></td></tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="company.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
