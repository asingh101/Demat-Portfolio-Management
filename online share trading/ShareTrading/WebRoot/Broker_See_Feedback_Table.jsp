...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="header">
    ...
    <div class="menu_nav">
      <ul>
        <li class="active"><a href="user.jsp">Home</a></li><li><a href="about.jsp">About Us</a></li>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; BROKER SEE&nbsp; THE FEEDBACKS</span></h2>
          <div class="clr"></div>
          <br>
 ...
 <table border="1">
       <tr><td>Subject</td><td>Date of post</td><td>View Post</td><td>View Reply</td><td>Reply Date</td></tr>
      <%  Map sess=ActionContext.getContext().getSession();
          ArrayList<LoginAction> alist=(ArrayList<LoginAction>)sess.get("seefeedreply");
          for(int i=0;i<alist.size();i++)
          {  %>    
    <tr><td align="center" height=50><%=alist.get(i).getSubject()%></td>
    <td align="center" height=50><%=alist.get(i).getDate()%></td>
    <td align="center" height=50><a href="reply1?uname=<%=alist.get(i).getUname()%>">View</a></td>
    <td align="center" height=50><a href="reply2?uname=<%=alist.get(i).getUname()%>">Reply</a></td>
    <td align="center" height=50><%=alist.get(i).getFname()%></td>
    </tr>
    <% } %>
  </table>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="Broker_Feedback_Mgt.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
