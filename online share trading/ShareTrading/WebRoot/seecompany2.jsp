    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <br>
          <s:form action="purchasehistory11">
          <p><font size="3" color="black">Company Names &nbsp;&nbsp;</font>
          <s:select label="company name" list="mapForSelect" name="comp_id" headerKey="-1" headerValue="--Please Select--"></s:select></p>
