    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <tr><td>user name</td><td>company name</td><td> No. of share</td><td>Process</td></tr>
         <tr><td><s:property value="username"/></td><td><s:property value="compname"/></td><td><s:property value="no_share"/></td><td><s:property value="Process"/></td></tr>
         </table>
