...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Company Feedback Home Page</span></h2>
          <div class="clr"></div>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <font size="3"></font><br></li>
                    <li><a href="Comp.jsp"><font size="3" color="blue">Home</font></a></li>
            <li><a href="User_give_FeedBack.jsp"><font size="3" color="blue">Send Feedback</font></a></li>
