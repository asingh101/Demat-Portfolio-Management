    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <tr><td>company name</td><td> No. of share</td><td>Amount of Transact</td><td>Date of transaction</td><td>type</td><td>Bywhom</td></tr>
          <%Map sess=ActionContext.getContext().getSession();
         ArrayList<LoginAction> alist=(ArrayList)sess.get("transhistory"); 
         for (int i=0;i<alist.size();i++)
         {
          %>
         <tr><td><%=alist.get(i).getCompname()%></td><td><%=alist.get(i).getNo_share()%></td><td><%=alist.get(i).getShareamt()%></td><td><%=alist.get(i).getDatetrans()%></td><td><%=alist.get(i).getType()%></td><td><%=alist.get(i).getByWhom()%></td></tr>
         <%} %>
         </table>
