...
<html>
  <head>
    ...
    <title>My JSP 'Edit company.jsp' starting page</title>
...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Risk Calculation</span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <br></p>
          <br>
          <s:form action="rcal">
          <p><font size="3" color="black">Company Names &nbsp;&nbsp;</font><s:select label="Select Company" list="mapForSelect" name="cid"></s:select></p>
  ...
  <div class="fbg">
    <div class="col c1">
      ...
      <img src="/KRITIKA/My Pictures/pic1.jpg" width="58" height="58" alt="" /> <a href="#"><img src="images/pic_2.jpg" width="58" height="58" alt="" /></a> <a href="#"><img src="images/pic_3.jpg" width="58" height="58" alt="" /></a> <a href="#"><img src="images/pic_4.jpg" width="58" height="58" alt="" /></a> <a href="#"><img src="images/pic_5.jpg" width="58" height="58" alt="" /></a> <a href="#"><img src="images/pic_6.jpg" width="58" height="58" alt="" /></a> </div>
    <div class="col c2">
