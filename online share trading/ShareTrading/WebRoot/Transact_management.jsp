...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar"><div class="article"><br><p class="spec"><br></p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li class="active">
            <a href="custhome.jsp"><font size="3">HOME</font></a></li>
            <li><a href="self"><font size="3">BY SELF</font></a></li>
            <li><a href="thbroker"><font size="3">BY BROKER</font></a></li>
            <li><a href="seehistory"><font size="3">SEE HISTORY</font></a></li>
            <li><a href="seedetails"><font size="3">SEE DETAILS</font></a></li>
  ...
  <div class="fbg">
    ...
    <div class="col c2">
      ...
      <p><br />
        Portfolio is a collection of asset i.e it means the total holding of securities belonging to any person.Portfolio management is all about distributing money in one or more investments after analyzing their future returns. <a href="#"></a> </p>
    </div>
    <div class="col c3">
