...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>BROKER GIVE FEED BACK</span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <br></p>
          <br>
           <br>
           <s:form action="givefeedback1"  name="myForm" onsubmit="return validateForm(this)" method="post">
<b><s:textfield name="subject" label="Subject" size="43"></s:textfield></b>
<b> <s:textarea cols="40" rows="5" name="content" label="Content"></s:textarea></b>

<table align="center">
<tr><td><input type="submit" value="Submit" ></td><td><input type="submit" value=" Cancel " onclick = "javascript:window.navigate('Broker_Feedback_Mgt.jsp')"></td><td><input type="RESET"></td></tr>
</table>
</s:form>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <font size="3"></font><br></li>
                    ...
                    <li><a href="Broker_Feedback_Mgt.jsp"><font size="3" color="Blue">Home</font></a></li>
	                <li><a href="Broker_give_Feed.jsp"><font size="3" color="Blue">Send Feedback</font></a></li>
	                <li><a href="replysee"><font size="3" color="Blue">See Reply</font></a></li>
          </ul>
        </div>
        <div class="gadget">
          <h2><span></span></h2>
