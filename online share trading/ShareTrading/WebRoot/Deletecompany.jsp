...
<html>
  <head>
    ...
    <title>My JSP 'Deletecompany.jsp' starting page</title>
    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <s:form action="deleteco">
          <p><font size="3" color="black">&nbsp;&nbsp;</font>
          <s:select label="Choose Company Name" list="mapForSelect" name="cid" headerKey="-1" headerValue="--Please Select--"></s:select></p>
