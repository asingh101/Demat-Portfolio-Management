...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Search for broker<br></span></h2>
          <div class="clr"></div>
          
          
          <s:form action="custmr">
          <p><font size="3" color="black">Names of Customers &nbsp;&nbsp;</font>
          <s:select label="username" list="mapForSelect" name="userid" headerKey="-1" headerValue="--Please Select--"></s:select></p>
