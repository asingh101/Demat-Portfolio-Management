...
<html>
  <head>
    ...
    <title>My JSP 'deletebroker.jsp' starting page</title>
...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>DELETE BROKER<br></span></h2>
          <div class="clr"></div>
          
          
          <s:form action="deletebroker">
          <p><font size="3" color="black">Names of Brokers &nbsp;&nbsp;</font><s:select label="SelectName" list="mapForSelect" name="broker_id"></s:select></p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="brokermgmnt.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
