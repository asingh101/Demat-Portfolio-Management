...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>EDIT BROKER</span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <br></p>
          <br><table>
          <s:form action="edbroker">
          <s:hidden name="broker_id"></s:hidden>
           ...
           <tr><td><s:textfield name="gender" label="Gender"></s:textfield></td></tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="Editbroker.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
