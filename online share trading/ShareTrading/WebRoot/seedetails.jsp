    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
         ...
         ArrayList<LoginAction> alist=(ArrayList)sess.get("seedetails"); 
         for (int i=0;i<alist.size();i++)
         {
          %>
         <tr><td><%=alist.get(i).getCompname()%></td><td><%=alist.get(i).getNo_share()%></td><td><%=alist.get(i).getBrokername()%></td><td><%=alist.get(i).getStatus()%></td><td><%=alist.get(i).getRemark()%></td><td><%=alist.get(i).getWant()%></td></tr>
         <%} %>
         </table>
