...
<script type="text/javascript" src="js/cuf_run.js"></script>
	<script type="text/javascript">
       function f(){
       var x12=document.forms["m"]["bankname"].value;
        if(x12=="") {
         alert("Error: BankName cannot be blank!");
          document.forms["m"]["bankname"].focus();
           return false; 
          } 
        var x13=document.forms["m"]["branchname"].value;
        if(x13=="") {
         alert("Error: Branchname cannot be blank!");
          document.forms["m"]["branchname"].focus();
           return false; 
          }  
        var x14=document.forms["m"]["bankaccount_no"].value;
        if(x14=="") {
         alert("Error: Bank Account no cannot be blank!");
          document.forms["m"]["bankaccount_no"].focus();
           return false; 
          } 
        var x15=document.forms["m"]["amtdep"].value;
        if(x15=="") {
         alert("Error: Amount cannot be blank!");
          document.forms["m"]["amtdep"].focus();
           return false; 
          }
          
           var x19=document.forms["m"]["demataccount_no"].value;
        if(x19=="") {
         ...
         var x17=document.forms["m"]["pancard_no"].value;
        if(x17=="") {
         alert("Error: pancard no cannot be blank!");
          document.forms["m"]["pancard_no"].focus();
           return false; 
          }
    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <br>
          <table>
          <s:form action="nextadd" name="m" onsubmit="return f()">
           <tr><td><s:hidden name="userid"/></td></tr>
            <tr><td><s:hidden name="username"/></td></tr>
             <tr><td><s:hidden name="password"/></td></tr>
           
          <tr><td><s:select label="brokername" list="mapForSelect" name="broker_id"></s:select></td></tr>
          <tr><td><s:textfield name="bankname" label="Bank name" ></s:textfield></td></tr>
          <tr><td><s:textfield name="branchname" label="Branch name"></s:textfield></td></tr>
          ...
          <tr><td><s:textfield name="demataccount_no" label="Demat Account no."></s:textfield></td></tr>
          <tr><td><s:textfield name="pancard_no" label="Pancard no."></s:textfield></td></tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2><span></span></h2>
          <a href="newuser.jsp"><font size="3" color="black">back</font></a>
          <div class="clr"></div>
