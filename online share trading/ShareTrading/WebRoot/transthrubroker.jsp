    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span></span></h2>
          <div class="clr"></div>
          <p class="post-data"> <span class="date"></span> <a href="#"></a> <a href="#"></a> <a href="#"></a></p>
          <br>
          
         <table>
         <tr><td><s:textfield name="CustName" label="Customer Name" ></s:textfield></td></tr>
          <tr><td><s:textfield name="AccounNo" label="Account No" ></s:textfield></td></tr>
          <tr><td><s:select name="ChooseCompany"  label="Choose Company" list='{"abc","xyz","pqr","lmn"}' ></s:select></td></tr>
          <tr><td><s:textfield name="NoOfShares" label="No of shares"></s:textfield></td></tr>
          <tr><td><s:radio name="" label="" list='{"Purchase","Sell"}' ></s:radio></td></tr>
          <tr><td><s:select name="ChooseBroker"  label="Choose Broker" list='{"abc","xyz","pqr","lmn"}' headerKey="-1" headerValue="-------------Please select---------"></s:select></td></tr>
