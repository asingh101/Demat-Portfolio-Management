...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>REPLY FEEDBACK</span></h2>
          <div class="clr"></div>
          
          
          <s:form action="replyfeedback">
         <s:hidden name="uname"></s:hidden>
         <font size=5> <b> <s:textarea cols="30" rows="5" name="content" label="Content"></s:textarea></b><br/><br/></font>
      <table align="center">
      <tr><td><input type="submit" value="ok" ></td><td><input type="submit" value=" Cancel " onclick = "javascript:window.navigate('Admin_See_Feedback.jsp')"></td><td><input type="RESET"></td></tr>
</table>
</s:form>
