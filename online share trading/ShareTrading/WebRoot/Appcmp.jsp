...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>APPROVE/REJECT COMPANY<br></span></h2>
          <div class="clr"></div>
          
          
                 <s:form action="appcomp">
          <p><font size="3" color="black"> &nbsp;&nbsp;</font>
          <s:select label="Choose Company" list="mapForSelect" name="comp_id" headerKey="-1" headerValue="--Please Select--"></s:select></p>
