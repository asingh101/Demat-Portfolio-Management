...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>ADMIN SEE AND REPLY THE FEEDBACKS</span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <br></p>
          <br>
           <br>
      <table border="1">
      <tr><td>Sender_ID</td><td>Subject</td><td></td><td>Date of Post</td><td></td><td>View Feedback</td><td>Reply Feedback</td></tr>
      <%  Map sess=ActionContext.getContext().getSession();
          ArrayList<LoginAction> alist=(ArrayList)sess.get("seefeed");
          for(int i=0;i<alist.size();i++)
          {  %>    
    <tr>
    <td><%=alist.get(i).getFname() %></td>
    <td><%=alist.get(i).getSubject()%></td><td></td>
    <td><%=alist.get(i).getDate()%></td><td></td>
    <td><a href="viewfeedback?uname=<%=alist.get(i).getUname()%>">View</a></td>
    <td><a href="replyfeedback1?uname=<%=alist.get(i).getUname()%>">Reply</a></td>
    </tr>
    <% } %>
  </table>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="Admin_Feedback_Mgt.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
