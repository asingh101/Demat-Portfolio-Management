    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <tr><td><s:textfield name="no.share" label="No.of share"></s:textfield></td></tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="companyreg.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
...
return at a given risk.<a href="#"></a></p>
  ...
  <div class="footer"><br><div class="footer_resize"><div class="clr"></div>
    </div>
  </div>
</div>
  </body>
