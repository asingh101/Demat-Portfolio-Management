...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    ...
    String q3="SELECT to_char(DATEOFTRANS,'dd-mm-yyyy'),sum(no_share) from share_details where comp_id="+cidd+"  and dateoftrans between to_date('"+sdate+"','DD-MM-YY')-7 and '"+sdate+"' group by(comp_id,DATEOFTRANS) order by DATEOFTRANS";
    ...
    JFreeChart chart = ChartFactory .createBarChart3D("Complete Share-Price Graph",s,"No. of Shares",dataset,PlotOrientation.VERTICAL,true, true, false);
