...
<html>
  <head>
    ...
    <title>My JSP 'brokermgmnt.jsp' starting page</title>
...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Broker Manangement</span></h2>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <a href="adminhome.jsp"><font size="3" color="black">back</font></a>
        <div class="gadget">
          <h2><span></span> </h2>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li class="active">
            <br></li>
             <li><a href="Approval"><font size="3" color="blue">Approve/Reject<br></font></a></li>
            
            <li><a href="Editbr"><font size="3" color="blue">Edit Broker<br></font></a></li>
            
            <li><a href="deletebr"><font size="3" color="blue">Delete Broker<br></font></a></li>
