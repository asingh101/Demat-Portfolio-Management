      ...
      <div class="mainbar">
        <div class="article">
          ...
          <tr><td><s:hidden name="reqid"/> </td></tr>
           <tr><td><s:hidden name="comp_id"/> </td></tr> 	
          <tr><td><s:hidden name="userid"/> </td></tr>
          <tr><td><s:textfield name="name" label="Customer Name" readonly="true"></s:textfield></td></tr>
          <tr><td><s:textfield name="account_no" label="Account no" readonly="true"></s:textfield></td></tr>
          <tr><td><s:textfield name="compname"  label="Company"></s:textfield></td></tr>
