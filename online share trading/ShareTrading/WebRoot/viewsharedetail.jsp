    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <tr><td>company name</td><td> No. of share</td><td>Share  Amount</td></tr>
          <%Map sess=ActionContext.getContext().getSession();
         ArrayList<LoginAction> alist=(ArrayList)sess.get("compsharedeatil"); 
         for (int i=0;i<alist.size();i++)
         {
          %>
         <tr><td><%=alist.get(i).getCompname() %></td><td><%=alist.get(i).getNo_share() %></td><td><%=alist.get(i).getShareamt() %></td></tr>
         <%
         } %>
         </table>
