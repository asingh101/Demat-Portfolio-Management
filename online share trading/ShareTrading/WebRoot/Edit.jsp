...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="header">
    <div class="logo">
      <h1><a href="index.html"><font size="6"><span>Portfolio Management</span></font><small><br></small></a></h1>
    </div>
    <div class="menu_nav">
      <ul>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>EDIT COMPANY</span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <br></p>
          <br><table>
          <tr><td><s:textfield name="name" label="Company Name"></s:textfield></td></tr>
           <tr><td><s:textfield name="name" label="Share Amount"></s:textfield></td></tr>
           <tr><td><s:textfield name="name" label="No of Share"></s:textfield></td></tr>
