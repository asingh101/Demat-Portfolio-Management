...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>&nbsp;&nbsp;&nbsp;&nbsp; Insufficient Balance</span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>  </p>
          <br>
          <h2>Sorry you can not purchase or sell. &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Your balance is insufficient!!!</h2>   
        
  
          </div><div class="article"><br><p class="spec"><br></p>
          <div class="clr"></div>
        </div>
  ...
  <div class="fbg">
    ...
    <div class="col c2">
      ...
      <p><br />
        Portfolio is a collection of asset i.e it means the total holding of securities belonging to any person.Portfolio management is all about distributing money in one or more investments after analyzing their future returns.
        </p>
    </div>
    <div class="col c3">
