...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Search for Company</span></h2>
          <div class="clr"></div>
          <p class="post-data">&nbsp;<span class="date"></span>    </p>
          <br>
         
          <table>
          <tr><td><s:select name="Name" label="Name"  list="{'abc','xyz','pqr'}" headerKey="-1" headerValue="--please select--"></s:select></td></tr>
          <tr></tr>
          <tr></tr>
          <tr></tr>
           <tr></tr>
          ...
          <tr></tr>
          <tr></tr>
          <tr><td><s:submit value="Search" align="center"></s:submit></td></tr>
          </table>
