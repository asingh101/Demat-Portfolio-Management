    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <s:hidden name="broker_id"></s:hidden>
           ...
           <tr><td><s:textarea name="experience" label="Experience" readonly="true"></s:textarea></td></tr>
         </table>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="custhome.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
