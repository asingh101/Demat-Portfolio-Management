    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <table>
          <tr><td><s:textfield name="uname" label="ID" ></s:textfield></td></tr>
          <tr><td><s:textfield name="uname" label="Bank Acc No" ></s:textfield></td></tr>
          <tr><td><s:textfield name="uname" label="Date" ></s:textfield></td></tr>
          <tr><td><s:radio name="type" label="type" list="{'purchase','sell'}" ></s:radio></td></tr>
          <tr><td><s:textfield name="uname" label="Amount" ></s:textfield></td></tr>
          <tr><td><s:textfield name="uname" label="ShareID" ></s:textfield></td></tr>
          <tr><td></td></tr>
          <tr><td></td></tr>
          <tr><td></td></tr>
          <tr><td></td></tr>
