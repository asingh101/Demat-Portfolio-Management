    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <br>
          <table>
          <s:form action="sale1" name="m" onsubmit="return f()">
          ...
          <tr><td><s:textfield name="no_share" label="No of shares" readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="acshare" label="Your Available shares" readonly="true"></s:textfield></td></tr>
          ...
          <tr><td><s:textfield name="type" label="U want to" ></s:textfield></td></tr>
        ...
        <div class="pagenavi"><span class="pages"></span><span class="current"></span></div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          <div class="search">
          ...
          <div class="clr"></div>
         <a href="self.jsp"><font size="3" color="black"> Back</font></a>
        </div>
        <div class="gadget">
          <h2><span></span> </h2>
          <div class="clr"></div>
