...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="header">
    <div class="logo">
      <h1><a href="index.html"><font size="6"><span>Portfolio Management</span></font><small></small></a></h1>
    </div>
    <div class="menu_nav">
      <ul>
    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <tr><td><s:hidden name="comp_id"></s:hidden></td></tr>
          <tr><td><s:hidden name="broker_id"></s:hidden></td></tr>
          ...
          <tr><td><s:textfield name="no_share" label="No of shares" readonly="true"></s:textfield></td></tr>
          <tr><td><s:textfield name="presentAmount" label="Present Amount" readonly="true"></s:textfield></td></tr>
          <tr><td><s:textfield name="amtcut" label="Amount deducted" readonly="true"></s:textfield></td></tr>
          <tr><td><s:textfield name="brokername" label="Register BrokerName" readonly="true"></s:textfield></td></tr>
          <tr><td><s:textfield name="type" label="U want to" readonly="true"></s:textfield></td></tr>
