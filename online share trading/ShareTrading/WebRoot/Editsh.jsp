...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>EDIT SHARE</span></h2><br>
          <div class="clr"></div>
          
          <table>
          <s:form action="edshare">
          ...
          <tr><td><s:textfield name="compname" label="Company Name"></s:textfield></td></tr>
           ...
           <tr><td><s:textfield name="no_share" label="No of Share"></s:textfield></td></tr>
            <tr><td><s:textfield name="stockIndex" label="Share Index"></s:textfield></td></tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="Comp.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
