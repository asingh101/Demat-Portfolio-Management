...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>&nbsp;CUSTOMER DETAILS<br></span></h2>
          ...
          <s:hidden name="userid"></s:hidden>
           ...
           <tr><td><s:textfield name="city" label="City" readonly="true"></s:textfield></td></tr>
           ...
           <tr><td><s:textfield name="dateofbirth" label="Date of Birth" readonly="true"></s:textfield></td></tr>
         <tr><td><s:textfield name="dateofreg" label="Date of Registration" readonly="true"></s:textfield></td></tr>
