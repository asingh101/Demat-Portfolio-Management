    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <tr><td><s:hidden name="userid"></s:hidden></td></tr>
