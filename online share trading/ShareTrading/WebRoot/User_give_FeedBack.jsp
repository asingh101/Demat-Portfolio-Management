...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>User Give Feedback</span></h2>
          <div class="clr"></div>
...
<table align="center">
<tr><td><input type="submit" value="Submit" ></td><td><input type="submit" value=" Cancel " onclick = "javascript:window.navigate('User_Feedback_Mgt.jsp')"></td><td><input type="RESET"></td></tr>
</table>
</s:form>
