...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>BROKER VIEW FEED BACK</span></h2>
          <div class="clr"></div>
          <br>
           ...
           <s:textarea cols="30" rows="5" name="content" label="Content is " readonly="true"></s:textarea>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <font size="3"></font><br></li>
                  ...
                  <li> <a href="Broker_Feedback_Mgt.jsp"><font size="3" color="black">back</font></a></li>
