...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>Company Manangement</span></h2>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="adminhome.jsp"><font size="3" color="blue">Home</font></a></li>
            <li><a href="Approvalcomp"><font size="3" color="blue">Approve / Reject Company</font></a></li>
            <li><a href="Deletecomp"><font size="3" color="blue">Delete Company</font></a></li>
