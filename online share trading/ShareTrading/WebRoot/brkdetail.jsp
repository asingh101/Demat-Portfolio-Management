...
<html>
  <head>
    ...
    <title>My JSP 'Edbr.jsp' starting page</title>
...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>&nbsp;BROKER DETAILS<br></span></h2>
          <div class="clr"></div>
          <br>
          <table>
          ...
          <s:hidden name="userid"></s:hidden>
           ...
           <tr><td><s:textfield name="firstname" label="FirstName" readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="lastname" label="LastName" readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="address" label="Address" readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="gender" label="Gender" readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="e_mail" label="E-mail"  readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="phone" label="Phone" readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="experience" label="Experience" readonly="true"></s:textfield></td></tr>
           <tr><td><s:textfield name="demataccount_no" label="Demat Acc No" readonly="true"></s:textfield></td></tr>
         <tr><td><s:textfield name="bankaccount_no" label="Bank Account No" readonly="true"></s:textfield></td></tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="brokerhome.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
