...
<script type="text/javascript">
       function f(frm){
       var tele = document.forms["myForm"]["no_share"].value; 
if(tele.length==0) {
            alert("Please enter telephone number");
            document.forms["myForm"]["no_share"].focus();
            return false; 
            }
            
if(isNaN(tele)||tele.indexOf(" ")!=-1){
    ...
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          ...
          <table>
          <s:form action="proc" name="myForm" onsubmit="return f(this)">

          <tr><td><s:hidden name="userid"/> </td></tr>
          <tr><td><s:hidden name="broker_id"/> </td></tr>
          <tr><td><s:textfield name="name" label="Customer Name" readonly="true"></s:textfield></td></tr>
          <tr><td><s:textfield name="demataccount_no" label="Demat ID" readonly="true"></s:textfield></td></tr>
          <tr><td><s:select name="compname"  label="Choose Company" list="mapForSelect" ></s:select></td></tr>
          <tr><td><s:textfield name="brokername"  label="Broker Name" readonly="true"></s:textfield></td></tr>
          <tr><td><s:textfield name="no_share" label="No of shares"></s:textfield></td></tr>
          <tr><td><s:radio name="type" label=" Enter Transaction type" list='{"Purchase","Sale"}' ></s:radio></td></tr>
          <tr><td><s:submit value="PROCEED" align="center"></s:submit></td></tr>
          </s:form>
          </table>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2><span></span> </h2>
          <div class="clr"></div>
         <a href="Transact_management.jsp"><font size="3" color="black">BACK</font></a>
  ...
  <div class="fbg">
    ...
    <div class="col c2">
      ...
      <p>Portfolio is a collection of asset i,e it means the total holding of securities belonging to any person.Portfolio management is all about distributing money in one or more investments after analyzing their future returns<br />
        <a href="#"></a></p>
    </div>
    <div class="col c3">
