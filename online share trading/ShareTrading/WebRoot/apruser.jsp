...
<script type="text/javascript" src="js/cuf_run.js"></script>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>APPROVE/REJECT CUSTOMER<br></span></h2>
          <div class="clr"></div>
          
          
          
                 <s:form action="appuser">
          <p><s:select label="SelectName" list="mapForSelect" name="userid"></s:select></p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <a href="Adminuser.jsp"><font size="3" color="black">back</font></a>
        </div>
        <div class="gadget">
          <h2><span><br></span></h2>
          <div class="clr"></div>
